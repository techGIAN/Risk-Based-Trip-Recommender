...
from utilityMethods import query, ROUTE_FROM, get_path_points
import branca.colormap as cm

# comment for now. load only once you have all dependencies
...
class Trip_Recommender(Location):
    ...
    def __init__(self, source, destination, trip_count, #isCurrentLocation=True, destination_coordinates=False, destination=None,
                    IS_DEBUG_MODE=False, IS_FULL_DEBUG_MODE=False,
                    ROUTE_FROM=ROUTE_FROM.OSRM, mode_of_transit='car',is_time_now = True, time_later_val = None):
    ...
    # ====== I DON'T THINK ANYONE'S USING THIS ======
